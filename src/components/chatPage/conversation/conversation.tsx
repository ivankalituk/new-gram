...
const Conversation: FC = () => {
  const [chatInfoShow, setChatInfoShow] = useState<boolean>(
    window.innerWidth >= 1450 ? true : false,
  );
    ...
    <div className="conversation">
      <div className="conversation_dialog">
        <div className="conversation_heading">
          ...
          <div
            className="conversation_heading_mainInfo"
            onClick={handleChatInfoShow}
          >
      ...
      <ChatInfo
        handleChatInfoHide={handleChatInfoHide}
        chatInfoShow={chatInfoShow}
      />
    </div>
  );
};
