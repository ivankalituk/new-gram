...
const ChatInfo: FC<ChatInfo> = ({ handleChatInfoHide, chatInfoShow }) => {
  // RESIZING
  const { handleMouseDown: handleChatsResize, blockSize: chatsSize } =
    useBlockResize(400, 500, 439, true);
  ...
  return (
    <div className={chatInfoShow ? "chatInfo open" : "chatInfo close"}>
      ...
      <div className="chatInfo_container" style={{ width: `${chatsSize}px` }}>
        ...
        <div className="chatInfo_mainInfo">
          ...
          <div className="chatInfo_mainInfo_info">
            <div className="chatInfo_mainInfo_info_name">
              Чат имени слоновьего поноса
            </div>
        ...
        <div className="chatInfo_actions">
          ...
          <div className="chatInfo_action">
            ...
            <div className="chatInfo_action_infoContainer">
              <div className="chatInfo_action_text">
                Короткое био с шуткой про твою мать, при чём био будет длинное,
                как и нос твоей матери чтоб я посмотрел на то как оно будет
                выглядеть в блоке
              </div>
          ...
          <div
            className="chatInfo_action_switch"
            onClick={handeNotificationToggle}
          >
      ...
      <ModalNotification
        enabled={modalAlert}
        enableChangeCallback={handleModalAlertDisable}
